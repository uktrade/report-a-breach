...
function setFocus(t, e = {}) {
    ...
    }), {once: !0}), null == (n = e.onBeforeFocus) || n.call(t), t.focus()
}
...
class Accordion extends GOVUKFrontendComponent {
    ...
    constructHeaderMarkup(t, e) {
        const n = t.querySelector(`.${this.sectionButtonClass}`), i = t.querySelector(`.${this.sectionHeadingClass}`),
    ...
    setExpanded(t, e) {
        const n = e.querySelector(`.${this.upChevronIconClass}`),
              ...
              s = e.querySelector(`.${this.sectionButtonClass}`), o = e.querySelector(`.${this.sectionContentClass}`);
    ...
    storeState(t) {
        if (this.browserSupportsSessionStorage && this.config.rememberExpanded) {
            ...
            if (e) {
                const t = e.getAttribute("aria-controls"), n = e.getAttribute("aria-expanded");
    ...
    setInitialState(t) {
        if (this.browserSupportsSessionStorage && this.config.rememberExpanded) {
            const e = t.querySelector(`.${this.sectionButtonClass}`);
            if (e) {
                const n = e.getAttribute("aria-controls"), i = n ? window.sessionStorage.getItem(n) : null;
...
Button.moduleName = "govuk-button", Button.defaults = Object.freeze({preventDoubleClick: !1});
...
class CharacterCount extends GOVUKFrontendComponent {
    constructor(t, e = {}) {
        ...
        const a = function (t, e) {
            ...
            for (const [i, s] of Object.entries(t)) {
                const t = [];
                for (const {required: n, errorMessage: i} of s) n.every((t => !!e[t])) || t.push(i);
                "anyOf" !== i || s.length - t.length >= 1 || n.push(...t)
            }
            return n
        }(CharacterCount.schema, this.config);
        if (a[0]) throw new ConfigError(`Character count: ${a[0]}`);
        this.i18n = new I18n(extractConfigByNamespace(this.config, "i18n"), {locale: closestAttributeValue(t, "lang")}), this.maxLength = null != (n = null != (i = this.config.maxwords) ? i : this.config.maxlength) ? n : 1 / 0, this.$module = t, this.$textarea = s;
    ...
    getAssociatedLegendOrLabel(t) {
        ...
        if (n) {
            ...
            if (e.length) {
                ...
                const i = n.getBoundingClientRect().top, s = t.getBoundingClientRect();
...
ErrorSummary.moduleName = "govuk-error-summary", ErrorSummary.defaults = Object.freeze({disableAutoFocus: !1});
...
NotificationBanner.moduleName = "govuk-notification-banner", NotificationBanner.defaults = Object.freeze({disableAutoFocus: !1});
...
class Radios extends GOVUKFrontendComponent {
    ...
    handleClick(t) {
        ...
        const n = document.querySelectorAll('input[type="radio"][aria-controls]'), i = e.form, s = e.name;
        n.forEach((t => {
            const e = t.form === i;
...
class SkipLink extends GOVUKFrontendComponent {
    constructor(t) {
        ...
        this.$module = t;
        const n = this.$module.hash, i = null != (e = this.$module.getAttribute("href")) ? e : "";
        let s;
        try {
...
class Tabs extends GOVUKFrontendComponent {
    ...
    onTabClick(t) {
        const e = this.getCurrentTab(), n = t.currentTarget;
...
function initAll(t) {
    ...
    const n = [[Accordion, t.accordion], [Button, t.button], [CharacterCount, t.characterCount], [Checkboxes], [ErrorSummary, t.errorSummary], [ExitThisPage, t.exitThisPage], [Header], [NotificationBanner, t.notificationBanner], [Radios], [SkipLink], [Tabs]],
