...
# AWS
AWS_ACCESS_KEY_ID = getattr(settings, "CHUNK_UPLOADER_AWS_ACCESS_KEY_ID", getattr(settings, "AWS_ACCESS_KEY_ID", None))
AWS_SECRET_ACCESS_KEY = getattr(
    settings, "CHUNK_UPLOADER_AWS_SECRET_ACCESS_KEY", getattr(settings, "AWS_SECRET_ACCESS_KEY", None)
)
...
) or settings.DEFAULT_FILE_STORAGE != "storages.backends.s3boto3.S3Boto3Storage":  # noqa W504  # noqa W503
    logger.warning(
        "It is strongly recommended that you use S3Boto3Storage " "or a class that inherits from it with this file handler"
    )
