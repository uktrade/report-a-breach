...
class TestViewASuspectedBreachView:
    ...
    def test_get_context_data(self, vasb_client, breach_object):
        response = vasb_client.get(f"/view_a_suspected_breach/{breach_object.id}/")
        assert response.context["breach"] == breach_object
