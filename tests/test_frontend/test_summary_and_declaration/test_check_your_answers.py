...
class TestCheckYourAnswersPersonOrBusinessYouAreReporting(conftest.PlaywrightTestBase):
    ...
    def test_can_change_companies_house_details(self):
        ...
        self.page.get_by_text("52 Avocet Close, Rugby, CV23 0WU, United Kingdom", exact=True).click()
        ...
        self.page.get_by_text("20-22 Wenlock Road, London, N1 7GU, United Kingdom").click()
        self.page.get_by_role("button", name="Continue").click()
        expect(self.page).to_have_url(re.compile(r".*/check-your-answers"))
        ...
        self.page.get_by_text("20-22 Wenlock Road, London, N1 7GU, United Kingdom", exact=True).click()
        self.page.get_by_role("link", name="Continue").click()
        self.declaration_and_complete_page(self.page)
