...
class TestUploadDocuments(conftest.PlaywrightTestBase):
    ...
    def test_correct_files_goes_to_suspected_breach(self):
        ...
        # self.page.get_by_text("Drag and drop files here or").click()
        # self.page.get_by_text("Choose files").click()
        # self.page.get_by_label("Upload a file").set_input_files(["./tests/test_frontend/testfiles/testfile.pdf"])
    ...
    def test_incorrect_filetype_raises_error(self):
        ...
        # self.page.get_by_text("Drag and drop files here or").click()
        # self.page.get_by_text("Choose files").click()
        # self.page.get_by_label("Upload a file").set_input_files(["./tests/test_frontend/testfiles/missing_filetype"])
    ...
    def test_malware_file_raises_error(self):
        ...
        # self.page.get_by_text("Drag and drop files here or").click()
        # self.page.get_by_text("Choose files").click()
        # self.page.get_by_label("Upload a file").set_input_files(["./tests/test_frontend/testfiles/malware_file_eicar.txt"])
        self.page.get_by_role("heading", name="There is a problem").click()
