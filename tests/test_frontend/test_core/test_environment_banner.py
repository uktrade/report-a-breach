...
class TestEnvironmentBannerProduction(PlaywrightTestBase):
    """Tests the production banner doesn't appear"""
...
class TestEnvironmentBannerNonProduction(PlaywrightTestBase):
