...
function mergeConfigs(...e) {
    const t = {};
    for (const s of e) for (const e of Object.keys(s)) {
        const n = t[e], i = s[e];
...
function setFocus(e, t = {}) {
    ...
    }), {once: !0}), null == (s = t.onBeforeFocus) || s.call(e), e.focus()
}
...
class Accordion extends GOVUKFrontendComponent {
    ...
    constructHeaderMarkup(e, t) {
        const s = e.querySelector(`.${this.sectionButtonClass}`), n = e.querySelector(`.${this.sectionHeadingClass}`),
    ...
    setExpanded(e, t) {
        const s = t.querySelector(`.${this.upChevronIconClass}`),
            ...
            i = t.querySelector(`.${this.sectionButtonClass}`), o = t.querySelector(`.${this.sectionContentClass}`);
        ...
        const a = [], l = t.querySelector(`.${this.sectionHeadingTextClass}`);
    ...
    storeState(e) {
        if (this.browserSupportsSessionStorage && this.config.rememberExpanded) {
            ...
            if (t) {
                const e = t.getAttribute("aria-controls"), s = t.getAttribute("aria-expanded");
    ...
    setInitialState(e) {
        if (this.browserSupportsSessionStorage && this.config.rememberExpanded) {
            const t = e.querySelector(`.${this.sectionButtonClass}`);
            if (t) {
                const s = t.getAttribute("aria-controls"), n = s ? window.sessionStorage.getItem(s) : null;
...
class CharacterCount extends GOVUKFrontendComponent {
    constructor(e, t = {}) {
        ...
        this.i18n = new I18n(this.config.i18n, {locale: closestAttributeValue(e, "lang")}), this.maxLength = null != (s = null != (n = this.config.maxwords) ? n : this.config.maxlength) ? s : 1 / 0, this.$module = e, this.$textarea = i;
        const l = `${this.$textarea.id}-info`, c = document.getElementById(l);
        if (!c) throw new ElementError({
            componentName: "Character count",
            element: c,
            identifier: `Count message (\`id="${l}"\`)`
        });
        `${c.textContent}`.match(/^\s*$/) && (c.textContent = this.i18n.t("textareaDescription", {count: this.maxLength})), this.$textarea.insertAdjacentElement("afterend", c);
    ...
    getCountMessage() {
        const e = this.maxLength - this.count(this.$textarea.value), t = this.config.maxwords ? "words" : "characters";
    ...
    getAssociatedLegendOrLabel(e) {
        ...
        if (s) {
            ...
            if (t.length) {
                ...
                const n = s.getBoundingClientRect().top, i = e.getBoundingClientRect();
...
class PasswordInput extends GOVUKFrontendComponent {
    constructor(e, t = {}) {
        ...
        this.$module = e, this.$input = s, this.$showHideButton = n, this.config = mergeConfigs(PasswordInput.defaults, t, normaliseDataset(PasswordInput, e.dataset)), this.i18n = new I18n(this.config.i18n, {locale: closestAttributeValue(e, "lang")}), this.$showHideButton.removeAttribute("hidden");
    ...
    setType(e) {
        ...
        const t = "password" === e, s = t ? "show" : "hide", n = t ? "passwordHidden" : "passwordShown";
...
class Radios extends GOVUKFrontendComponent {
    constructor(e) {
        ...
        this.$module = e, this.$inputs = t, this.$inputs.forEach((e => {
            const t = e.getAttribute("data-aria-controls");
            if (t) {
                // todo - we've removed throwing an error here as per the original JS as it's not
                // compatible with the current version of crispy-forms-gds
                e.setAttribute("aria-controls", t), e.removeAttribute("data-aria-controls")
            }
        })), window.addEventListener("pageshow", (() => this.syncAllConditionalReveals())), this.syncAllConditionalReveals(), this.$module.addEventListener("click", (e => this.handleClick(e)))
    }
    ...
    handleClick(e) {
        ...
        const s = document.querySelectorAll('input[type="radio"][aria-controls]'), n = t.form, i = t.name;
        s.forEach((e => {
            const t = e.form === n;
...
class SkipLink extends GOVUKFrontendComponent {
    constructor(e) {
        ...
        this.$module = e;
        const s = this.$module.hash, n = null != (t = this.$module.getAttribute("href")) ? t : "";
        let i;
        try {
...
class Tabs extends GOVUKFrontendComponent {
    constructor(e) {
        ...
        if (!s) throw new ElementError({componentName: "Tabs", identifier: 'List (`<ul class="govuk-tabs__list">`)'});
        if (!n.length) throw new ElementError({
            componentName: "Tabs",
    ...
    onHashChange() {
        const e = window.location.hash, t = this.getTab(e);
        if (!t) return;
    ...
    onTabClick(e) {
        const t = this.getCurrentTab(), s = e.currentTarget;
...
function initAll(e) {
    ...
    const s = [[Accordion, e.accordion], [Button, e.button], [CharacterCount, e.characterCount], [Checkboxes], [ErrorSummary, e.errorSummary], [ExitThisPage, e.exitThisPage], [Header], [NotificationBanner, e.notificationBanner], [PasswordInput, e.passwordInput], [Radios], [SkipLink], [Tabs]],
