...
from report_a_suspected_breach.views import generic, views_a, views_b, views_c, views_e
...
urlpatterns = generic_urls + views_a_urls + views_b_urls + views_c_urls + views_e_urls
