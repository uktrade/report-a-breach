...
def show_check_company_details_page_condition(wizard: View) -> bool:
...
def show_about_the_supplier_page(wizard: View) -> bool:
...
def show_name_and_business_you_work_for_page(wizard: View) -> bool:
...
def show_name_page(wizard: View) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("start")
...
def show_end_user_added_page(wizard: View) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("where_were_the_goods_supplied_to")
    cleaned_data_available_step = wizard.get_cleaned_data_for_step("where_were_the_goods_made_available_to")
    choices = ["in_the_uk", "outside_the_uk"]
    return (
...
def show_where_were_the_goods_supplied_to_page(wizard: View) -> bool:
...
def show_where_were_the_goods_made_available_to_page(wizard: View) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("where_were_the_goods_made_available_from")
