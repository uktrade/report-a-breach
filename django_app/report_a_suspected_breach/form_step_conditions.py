...
def show_check_company_details_page_condition(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_where_is_the_address_of_the_business_or_person_page_condition(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_do_you_know_the_registered_company_number_page(wizard: OrderedDict[Any, Any]) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("are_you_reporting_a_business_on_companies_house")
    return cleaned_data.get("business_registered_on_companies_house", False) == "yes"


def show_about_the_supplier_page(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_where_were_the_goods_made_available_from_page(wizard: OrderedDict[Any, Any]) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("where_were_the_goods_supplied_from")
...
def show_business_or_personal_details_page(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_name_and_business_you_work_for_page(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_name_page(wizard: OrderedDict[Any, Any]) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("start")
    return cleaned_data.get("reporter_professional_relationship") in ("owner", "acting")


def show_about_the_end_user_page(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_end_user_added_page(wizard: OrderedDict[Any, Any]) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("where_were_the_goods_supplied_to")
    cleaned_data_available_step = wizard.get_cleaned_data_for_step("where_were_the_goods_made_available_to")
    choices = ["in_the_uk", "outside_the_uk"]
    return (
...
def show_where_were_the_goods_supplied_to_page(wizard: OrderedDict[Any, Any]) -> bool:
...
def show_where_were_the_goods_made_available_to_page(wizard: OrderedDict[Any, Any]) -> bool:
    cleaned_data = wizard.get_cleaned_data_for_step("where_were_the_goods_made_available_from")
